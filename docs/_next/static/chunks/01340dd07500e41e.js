(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, n) => {
		...
		async function W(t = {}) {
			...
			if (
				...
				let { initScriptLoader: t } = e.r(49534);
				t(l.scriptLoader);
			}
					...
					.then(({ page: r, styleSheets: l }) =>
						s?.Component === r
							? e
									.A(13164)
									.then((r) =>
										e.A(10005).then((e) => ((t.App = n = e.default), r)),
									)
	...
	(e, t, n) => {
		'use strict';
		(Object.defineProperty(n, '__esModule', { value: !0 }), e.r(3620));
		let r = e.r(50845),
			l = e.r(2939);
		((window.next = {
			version: r.version,
