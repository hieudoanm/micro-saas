(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, n) => {
		...
		function X(e) {
			($.current === e && (U(H), U($)),
				W.current === e && (U(W), (s7._currentValue = D)));
		}
		function K(e) {
			if (void 0 === tM)
				try {
		...
		function tn(e, t, n, r, l, a, o, u) {
			if (
				...
				if (('submit' === a || 'reset' === a) && null == t) return void e8(e);
				((n = null != n ? '' + e4(n) : ''),
					(t = null != t ? '' + e4(t) : n),
		...
		var t2 = tz(
			...
			t6 = tz(m({}, tU, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
			t8 = tz(
				m({}, tV, {
					deltaX: function (e) {
						return 'deltaX' in e
		...
		function n3(e, t, n, r) {
			return (n2(e, t, n, r), n8(e));
		}
		function n4(e, t) {
			return (n2(e, null, null, t), n8(e));
		}
		function n6(e, t, n) {
			e.lanes |= n;
			var r = e.alternate;
		...
		function rr(e, t, n, r, l, a) {
			...
			if (((r = e), 'function' == typeof e)) re(e) && (o = 1);
				...
				e: switch (e) {
					...
					case S:
						return (
							((e = n7(12, n, t, 2 | l)).elementType = S),
							(e.lanes = a),
							e
						);
					case _:
						return (((e = n7(13, n, t, l)).elementType = _), (e.lanes = a), e);
					case x:
						return (((e = n7(19, n, t, l)).elementType = x), (e.lanes = a), e);
					default:
		...
		function rO(e) {
			...
			switch (((t[ez] = e), (t[eM] = r), n)) {
				...
				case 'video':
				case 'audio':
					for (n = 0; n < i2.length; n++) i6(i2[n], t);
					break;
				case 'source':
					i6('error', t);
					break;
				...
				case 'select':
					...
					break;
				case 'textarea':
					(i6('invalid', t), to(t, r.value, r.defaultValue, r.children));
			}
			...
			si(t.textContent, n)
				? (null != r.popover && (i6('beforetoggle', t), i6('toggle', t)),
					null != r.onScroll && i6('scroll', t),
					null != r.onScrollEnd && i6('scrollend', t),
		...
		function rM() {
			...
			return (
				null !== e &&
					(null === uK ? (uK = e) : uK.push.apply(uK, e), (rT = null)),
				e
			);
		}
		function rD(e) {
		...
		var rK =
			...
			rY = a.unstable_scheduleCallback,
		...
		function r8() {
			if (0 == --r3 && null !== r2) {
				null !== r6 && (r6.status = 'fulfilled');
				var e = r2;
				((r2 = null), (r4 = 0), (r6 = null));
		...
		function l8(e) {
			...
			if (
				((lq = 0), (lX = lG = lQ = null), (lK = !1), (l0 = 0), (l1 = null), t)
			)
				throw Error(i(300));
		...
		function at(e) {
			...
			((lq = 0), (lX = lG = lQ = null), (lY = !1), (l0 = lJ = 0), (l1 = null));
		}
		function an() {
			var e = {
				memoizedState: null,
		...
		function ac(e, t, n) {
			...
			if (((a = e.baseState), null === l)) e.memoizedState = a;
				...
				if (
					(null === s ? (o = a) : (s.next = u),
					!n_(a, e.memoizedState) && ((ov = !0), f && null !== (n = r6)))
				)
					throw n;
				((e.memoizedState = a),
					(e.baseState = o),
		...
		function aG(e, t, n, r, l) {
			...
			try {
				...
				a6(e, t, { then: function () {}, status: 'rejected', reason: n }, ir());
			} finally {
				((M.p = a),
		...
		function a3(e, t, n) {
			...
			((n = {
				...
				a5(e)
					? a9(t, n)
					: null !== (n = n3(e, t, n, r)) && (ia(n, e, r), a7(n, t, r)));
		}
		function a4(e, t, n) {
			a6(e, t, n, ir());
		}
		...
		function oS(e, t, n, r, l) {
			...
			return (rq(t), (r = l6(e, t, n, o, a, l)), (u = l7()), null === e || ov)
			...
			switch (((t.lanes = 0), t.tag)) {
				...
				case 5:
					return (
						...
						null !== t.memoizedState &&
							(s7._currentValue = l = l6(e, t, l9, null, null, n)),
						oC(e, t),
						ob(e, t, r, n),
						t.child
					);
		...
		function uo(e, t, n) {
			...
			switch (n.tag) {
				...
				case 26:
				case 5:
					(uv(e, n), null === t && 4 & r && o6(n), 512 & r && o3(n, n.return));
					break;
				case 12:
				default:
					uv(e, n);
					...
					if (
						...
						if (((r = e.memoizedState), null === n))
							...
							a !== r
								...
								: null === r &&
									null !== e.stateNode &&
									o8(e, e.memoizedProps, n.memoizedProps);
					}
					break;
				case 27:
					(um(t, e),
									...
									if (null === n.instance) {
										...
										if (a) {
											(null !== (t = a._p) &&
												'object' == typeof t &&
												'function' == typeof t.then &&
												(e.count++, (e = s6.bind(e)), t.then(e, e)),
												(n.state.loading |= 4),
												(n.instance = a),
												eQ(a));
											return;
		...
		var uO = {
			...
			it = null;
		function ir() {
			return 0 != (2 & uA) && 0 !== uD ? uD & -uD : null !== z.T ? iY() : eO();
		}
		function il() {
			if (0 === uQ)
			...
			for (
				...
				if (0 === l) uU && !r && ii(e, t, 0, !1);
					...
					e: {
						...
						iu(r, n, uK, u1, uY, t, uQ, uW, uG, uj, a, null, -0, 0);
					}
				}
				break;
			}
				...
				var n = (function (e, t, n) {
					...
					switch ((rk(t), t.tag)) {
						...
						case 4:
							return (
								Q(),
								null === e && i9(t.stateNode.containerInfo),
								oY(t),
								null
							);
						case 10:
						...
						case 19:
							if ((U(lV), null === (r = t.memoizedState))) return (oY(t), null);
		...
		function iT() {
			if (4 === u3 || 3 === u3) {
				...
				0 != (10256 & t.subtreeFlags) || 0 != (10256 & t.flags)
					? (u3 = 5)
					: ((u3 = 0), (u6 = u4 = null), iC(e, e.pendingLanes));
		...
		function iR() {
			...
			var n = eR(u8),
				...
				l = M.p;
			try {
				((M.p = 32 > n ? 32 : n), (z.T = null), (n = u9), (u9 = null));
				var a = u4,
					o = u8;
				if (((u3 = 0), (u6 = u4 = null), (u8 = 0), 0 != (6 & uA)))
					throw Error(i(331));
				var u = uA;
				if (
					((uA |= 4),
		...
		for (var i0 = 0; i0 < nX.length; i0++) {
			var i1 = nX[i0];
			nK(i1.toLowerCase(), 'on' + (i1[0].toUpperCase() + i1.slice(1)));
		}
		(nK(nB, 'onAnimationEnd'),
			nK(nH, 'onAnimationIteration'),
			nK(n$, 'onAnimationStart'),
			nK('dblclick', 'onDoubleClick'),
			nK('focusin', 'onFocus'),
			nK('focusout', 'onBlur'),
			nK(nV, 'onTransitionRun'),
			nK(nW, 'onTransitionStart'),
			...
			if (!e[i5]) {
				((e[i5] = !0),
					eG.forEach(function (t) {
						'selectionchange' !== t &&
							(i3.has(t) || i8(t, !1, e), i8(t, !0, e));
					}));
				var t = 9 === e.nodeType ? e : e.ownerDocument;
				null === t || t[i5] || ((t[i5] = !0), i8('selectionchange', !1, t));
			}
		}
		function i7(e, t, n, r) {
			switch (cm(t)) {
				...
				if (0 == (7 & t)) {
					...
					(w &&
						...
						(y = nt
							...
							((S = new tK('onBeforeInput', 'beforeinput', null, n, l)),
		...
		function ss(e, t, n, r, l, a) {
			switch (n) {
				...
				case 'start':
					...
					break;
				case 'popover':
					(i6('beforetoggle', e), i6('toggle', e), e1(e, 'popover', r));
					break;
				case 'xlinkActuate':
		...
		function sf(e, t, n) {
			switch (t) {
				...
				case 'input':
					...
					return;
				case 'select':
					for (a in (i6('invalid', e), (l = o = r = null), n))
					...
					return;
				case 'textarea':
					for (o in (i6('invalid', e), (r = a = l = null), n))
				...
				case 'video':
				case 'audio':
					for (l = 0; l < i2.length; l++) i6(i2[l], e);
					break;
				case 'image':
					(i6('error', e), i6('load', e));
					break;
		...
		var cD = o.version;
		if ('19.2.0' !== cD) throw Error(i(527, cD, '19.2.0'));
		if (
	...
	(e, t, n) => {
		...
		let d = 'phase-export',
			...
			C = 'prerender-manifest.json',
			N = 'routes-manifest.json',
			R = 'images-manifest.json',
			O = 'required-server-files.json',
			L = '_devPagesManifest.json',
			A = 'middleware-manifest.json',
			z = '_clientMiddlewareManifest.json',
			M = 'client-build-manifest.json',
			...
			Z = 'dynamic-css-manifest',
			J = 'main',
			ee = `${J}-app`,
			et = 'app-pages-internals',
			en = 'react-refresh',
			er = 'webpack',
			el = 'polyfills',
			ea = Symbol(el),
	...
	(e, t, n) => {
		...
		async function W(t = {}) {
			...
			if (
				...
				let { initScriptLoader: t } = e.r(85408);
				t(l.scriptLoader);
			}
					...
					.then(({ page: r, styleSheets: l }) =>
						s?.Component === r
							? e
									.A(30830)
									.then((r) =>
										e.A(41165).then((e) => ((t.App = n = e.default), r)),
									)
		...
		let Y = 'beforeRender',
			...
			ea = !0;
		function eo() {
			[Y, J, Z, ee].forEach((e) => performance.clearMarks(e));
		}
		function eu() {
			T.ST &&
				(performance.mark(J),
				performance.getEntriesByName(Y, 'mark').length &&
					(performance.measure(
						'Next.js-before-hydration',
						'navigationStart',
						Y,
					),
					performance.measure(et, Y, J)),
		...
		function ei() {
			...
			e.length &&
				(performance.getEntriesByName(Y, 'mark').length &&
					(performance.measure(en, e[0].name, Y),
					performance.measure(er, Y, Z),
					d &&
	...
	(e, t, n) => {
		'use strict';
		(Object.defineProperty(n, '__esModule', { value: !0 }), e.r(87258));
		let r = e.r(76202),
			l = e.r(68917);
		((window.next = {
			version: r.version,
