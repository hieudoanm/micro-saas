(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
				...
				!(function e(t, r, n, i, a) {
					...
					if (j(t))
						...
						for (t = m.call(t), m = 0; !(i = t.next()).done; )
							((f = p + N((i = i.value), m++)), (d += e(i, r, n, f, a)));
					else if ('object' === f) {
	...
	(e) => {
		...
		e.s([
			...
			({ children: e }) => {
				let [
						{ isAuthenticated: u = !1, isLoading: i = !1, user: a = null },
						s,
					] = (0, n.useState)({
						isAuthenticated: !1,
						isLoading: !1,
					...
					c = async () => {
						...
						try {
							...
							s((t) => ({ ...t, isAuthenticated: !0, user: e }));
						} catch (e) {
							(console.error(e),
								s((e) => ({ ...e, isAuthenticated: !1, user: null })));
						} finally {
							s((e) => ({ ...e, isLoading: !1 }));
						}
					},
	...
	(e) => {
		...
		var t = e.i(68601),
			...
			u = e.i(37914);
		let i = {
			className: u.default.className,
			style: { fontFamily: "'Geist', 'Geist Fallback'", fontStyle: 'normal' },
		};
		null != u.default.variable && (i.variable = u.default.variable);
		var a = e.i(24510);
		let s = {
			className: a.default.className,
			style: {
		...
		let l = o.trpcHook.withTRPC(({ Component: e, pageProps: o }) =>
			(0, t.jsxs)(t.Fragment, {
				children: [
					(0, t.jsx)(c.default, {
						children: (0, t.jsx)('title', { children: r.APP_NAME }),
					}),
					(0, t.jsx)('div', {
						className: `${i.className} ${s.className}`,
						children: (0, t.jsx)(n.UserProvider, {
							children: (0, t.jsx)(e, { ...o }),
						}),
					}),
				],
			}),
		);
		e.s(['default', 0, l], 16027);
	},
	94757,
	(e, t, r) => {
		let n = '/_app';
		((window.__NEXT_P = window.__NEXT_P || []).push([n, () => e.r(16027)]),
			t.hot &&
	...
	(e) => {
		e.v((t) =>
			Promise.all(
				['static/chunks/ee4e37f381dad0cd.js'].map((t) => e.l(t)),
			).then(() => t(57707)),
		);
	},
	4437,
