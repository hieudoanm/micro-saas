(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, n) => {
		...
		async function W(t = {}) {
			...
			if (
				...
				let { initScriptLoader: t } = e.r(77128);
				t(l.scriptLoader);
			}
					...
					.then(({ page: r, styleSheets: l }) =>
						s?.Component === r
							? e
									.A(20276)
									.then((r) =>
										e.A(2759).then((e) => ((t.App = n = e.default), r)),
									)
	...
	(e, t, n) => {
		'use strict';
		(Object.defineProperty(n, '__esModule', { value: !0 }), e.r(36546));
		let r = e.r(39318),
			l = e.r(33576);
		((window.next = {
			version: r.version,
