			...
			let b = a.default.forwardRef(function (e, t) {
											...
											if (
												...
												e.preventDefault(),
													(() => {
														...
														let e = null == n || n;
														'beforePopState' in t
															? t[l ? 'replace' : 'push'](r, s, { shallow: a, locale: o, scroll: e })
					...
					if ((0, u.isAbsoluteUrl)(R)) W.href = R;
						...
						W.href =
							...
							(0, x.addBasePath)((0, c.addLocale)(R, e, null == L ? void 0 : L.defaultLocale));
					}
					return O ? a.default.cloneElement(s, W) : (0, l.jsx)('a', { ...P, ...W, children: r });
				}),
		...
		4353: (e, t, r) => {
			...
			let l = (e) => {
					...
					return (0, s.jsx)('button', {
						className: 'cursor-pointer rounded-lg bg-gradient-to-r from-red-800 via-purple-800 to-blue-800 px-4 py-2',
						children: t,
					});
				},
				a = (e) => {
						...
						children: (0, s.jsxs)('div', {
							...
							children: [
								...
								(0, s.jsx)('div', {
									...
									children: (0, s.jsx)(a, { children: 'Get Started' }),
								}),
							],
						}),
					});
						...
						children: [
							...
							(0, s.jsx)('div', {
								...
								children: [
									...
									let { id: t = '', emoji: r = '', title: l = '', description: a = '' } = e;
									return (0, s.jsx)(
										'div',
										{
											...
											children: (0, s.jsxs)('div', {
												...
												children: [
													...
													(0, s.jsx)('p', { className: 'text-center text-sm text-neutral-400', children: a }),
												],
											}),
										},
										t,
					...
					(0, s.jsx)('section', {
						...
						children: (0, s.jsxs)('div', {
							...
							children: [
								...
								(0, s.jsx)('div', {
									className: 'flex w-full items-center justify-center',
									children: (0, s.jsx)(l, { children: 'Get Started' }),
								}),
							],
						}),
					}),
						...
						children: (0, s.jsx)('div', {
							...
							children: (0, s.jsxs)('div', {
								...
								children: [
									...
									(0, s.jsx)(l, { children: 'Get Started' }),
								],
							}),
						}),
					}),
				...
				return (0, s.useCallback)(
					(s) => {
						if (null === s) {
							...
							let t = l.current;
							t && ((l.current = null), t());
						} else e && (r.current = a(e, s)), t && (l.current = a(t, s));
					},
					[e, t],
				);
			}
