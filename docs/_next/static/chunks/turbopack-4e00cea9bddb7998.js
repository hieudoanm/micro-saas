((globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	{
		otherChunks: [
			'static/chunks/5475d17665eccc11.js',
			'static/chunks/074584da60357c7e.js',
			'static/chunks/92cacf9a5962fcae.js',
			'static/chunks/5a110a00d28276d4.js',
			'static/chunks/53eea340ba37ef50.js',
			'static/chunks/4fff0dfe8f8ce841.css',
		],
		runtimeModuleIds: [47203, 94757],
	},
]),
	(() => {
		let e;
		if (!Array.isArray(globalThis.TURBOPACK)) return;
		let t = '/micro-saas/_next/',
			r =
		...
		let i = o.prototype,
			...
			s = 'undefined' != typeof Symbol && Symbol.toStringTag;
		function u(e, t, r) {
		...
		((i.s = function (e, t) {
			...
			(i.v = function (e, t) {
				(null != t ? c(this.c, t) : this.m).exports = e;
			}),
			(i.n = function (e, t) {
				let r;
				(r = null != t ? c(this.c, t) : this.m).exports = r.namespaceObject = e;
			}));
		...
		((i.i = m),
			...
			(i.f = function (e) {
				function t(t) {
					if (((t = b(t)), l.call(e, t))) return e[t].module();
				...
				return (
					...
					(t.resolve = (t) => {
						if (((t = b(t)), l.call(e, t))) return e[t].id();
						let r = Error(`Cannot find module '${t}'`);
						throw ((r.code = 'MODULE_NOT_FOUND'), r);
					}),
		...
		i.a = function (e, t) {
			let r = this.m,
				...
				o = new Set(),
				{ resolve: i, reject: l, promise: s } = y(),
				u = Object.assign(s, {
					[g]: r.exports,
					[O]: (e) => {
			...
			(Object.defineProperty(r, 'exports', c),
				...
				e(
					function (e) {
						...
						return (t.map((e) => e[O](u)), s.queueCount ? i : r());
					},
					function (e) {
						(e ? l((u[w] = e)) : i(u[g]), C(n));
					},
		...
		async function S(e, t, r) {
			...
			if (s.length > 0) {
				...
				for (let o of ((n = E(e, t, K(r.path))), l)) P.has(o) || P.set(o, n);
			}
