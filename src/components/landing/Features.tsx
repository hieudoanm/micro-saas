...
export type FeaturesProps = { title: string; description: string; features: Record<string, Feature> };

export const Features: FC<FeaturesProps> = ({ title = '', description = '', features = {} }) => {
	return (
