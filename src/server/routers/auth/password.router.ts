...
export const authPassword = {
	forget: publicProcedure.input(z.object({ email: z.string() })).mutation(async (options) => {
	...
	reset: publicProcedure.input(z.object({ token: z.string(), password: z.string() })).mutation(async (options) => {
